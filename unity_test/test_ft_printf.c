...
void	test_ft_printf_0char(void)
{
	char	*expect;
	int		expect_len;
	int		given_len;
...
void	test_ft_printf_minIint(void)
{
	...
	expect = "-2147483648";
	expect_len = 11;
	given_len = ft_printf("%i", (int)MIN_INT);
	ft_readBuffer(out, buf);
	ft_clearFile(file, out);
	TEST_ASSERT_EQUAL(expect_len, given_len);
	TEST_ASSERT_EQUAL_STRING(expect, buf);
...
void	test_ft_printf_minDint(void)
{
	...
	expect = "-2147483648";
	expect_len = 11;
	given_len = ft_printf("%d", (int)MIN_INT);
	ft_readBuffer(out, buf);
	ft_clearFile(file, out);
	TEST_ASSERT_EQUAL(expect_len, given_len);
	TEST_ASSERT_EQUAL_STRING(expect, buf);
...
void	test_ft_printf_maxUint(void)
{
	...
	expect = "4294967295";
	expect_len = 10;
	given_len = ft_printf("%u", (unsigned)MAX_UINT);
	ft_readBuffer(out, buf);
	ft_clearFile(file, out);
	TEST_ASSERT_EQUAL(expect_len, given_len);
	TEST_ASSERT_EQUAL_STRING(expect, buf);
...
void	test_ft_printf_maxHexadecS(void)
{
	...
	expect = "ffffffff";
	expect_len = 8;
	given_len = ft_printf("%x", (unsigned)MAX_UINT);
	ft_readBuffer(out, buf);
	ft_clearFile(file, out);
	TEST_ASSERT_EQUAL(expect_len, given_len);
	TEST_ASSERT_EQUAL_STRING(expect, buf);
...
void	test_ft_printf_alter0Precision0HexadecS(void)
{
	char	*expect;
	int		expect_len;
	int		given_len;
...
void	test_ft_printf_alter0Precision0HexadecB(void)
{
	char	*expect;
	int		expect_len;
	int		given_len;
...
void	test_ft_printf_output(void)
{
	char	*expect;
	int		expect_len;
	int		given_len;
	...
	expect = " 1 0 ";
	expect_len = 7;
	given_len = ft_printf(" %c %c %c ", '1', '0', 0);
	ft_readBuffer(out, buf);
	ft_clearFile(file, out);
	TEST_ASSERT_EQUAL_STRING(expect, buf);
	TEST_ASSERT_EQUAL(expect_len, given_len);
...
int	main(void)
{
	...
	RUN_TEST(test_ft_printf_output);
	// cp and sed test
